...
namespace Core.RequestValidation
{
  /// <summary>
  ...
  public class ModelValidationFilterAttribute : IActionFilter
  {
    ...
    public void OnActionExecuting(ActionExecutingContext context)
    {
      ...
      if (!context.ModelState.IsValid)
      {
        ...
        {
          hasErrors = true;
          if (modelErrors[0].Exception != null)
          {
        ...
        if (modelPropertyStateErrors.Any())
        {
          ...
          context.Result = hasErrors ? new BadRequestObjectResult(modelErrorMessage) : new BadRequestObjectResult(propertyStateError);
        }
